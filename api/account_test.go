...
func TestGetAccountApi(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			setupAuth: func(t *testing.T, request *http.Request, tokenMaker token.Maker) {
				addAuthorization(t, request, tokenMaker, authorizationHeaderType, user.Username, time.Minute)
			},
			buildStubs: func(store *mockdb.MockStore) {
				store.EXPECT().
			...
			checkResponse: func(t *testing.T, recorder *httptest.ResponseRecorder) {
				...
				requirBodyMatchAccount(t, recorder.Body, account)
			},
		},
		{
			name:      "NotFound",
...
func requirBodyMatchAccount(t *testing.T, body *bytes.Buffer, account db.Account) {
